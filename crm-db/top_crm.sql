...
Source Database       : top_crm

Target Server Type    : MYSQL
Target Server Version : 50611
File Encoding         : 65001

Date: 2017-04-14 11:19:26
*/
...
-- ----------------------------
-- Table structure for csc_customer
-- ----------------------------
DROP TABLE IF EXISTS `csc_customer`;
CREATE TABLE `csc_customer` (
  `row_id` bigint(20) unsigned NOT NULL,
  `customer_no` varchar(20) NOT NULL COMMENT '经销商编号_search',
  `customer_name` varchar(100) NOT NULL COMMENT '经销商名称(简称)_search',
  `customer_full_name` char(128) DEFAULT NULL COMMENT '经销商全称',
  `corp_no` varchar(20) NOT NULL COMMENT '公司编号',
  `customer_address` varchar(100) DEFAULT NULL COMMENT '经销商地址',
  `contacts` varchar(64) DEFAULT NULL COMMENT '联系人',
  `contact_number` varchar(64) DEFAULT NULL COMMENT '联系电话',
  `is_pos_store` char(1) DEFAULT NULL COMMENT '是否POS店铺',
  `user_id` bigint(20) NOT NULL COMMENT '会员Id',
  `valid_flag` char(1) DEFAULT 'Y' COMMENT '有效标识(Y-有效 N-作废)',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`row_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='经销商档案表';

-- ----------------------------
-- Records of csc_customer
-- ----------------------------
INSERT INTO `csc_customer` VALUES ('97087064788434946', 'test001', '測試公司', '大祭司', '1111', '阿方索', '儅', '15121118965', null, '97087064788434944', 'Y', '2017-04-11 11:58:44');

-- ----------------------------
-- Table structure for csc_store
-- ----------------------------
DROP TABLE IF EXISTS `csc_store`;
CREATE TABLE `csc_store` (
  `store_id` bigint(20) unsigned NOT NULL,
  `store_no` varchar(20) NOT NULL COMMENT '店铺编号_search',
  `store_name` varchar(200) DEFAULT NULL COMMENT '店铺名称',
  `customer_no` varchar(20) DEFAULT NULL COMMENT '经销商编号',
  `city_name` varchar(20) DEFAULT NULL COMMENT '所在城市',
  `store_nature` bigint(20) DEFAULT NULL COMMENT '店铺经营性质',
  `store_status` bigint(20) DEFAULT NULL COMMENT '店铺状态',
  `store_level` bigint(20) DEFAULT NULL COMMENT '店铺级别',
  `start_date` date DEFAULT NULL COMMENT '开业日期',
  `business_area` varchar(20) DEFAULT NULL COMMENT '卖场面积',
  `province` bigint(20) DEFAULT NULL COMMENT '省/直辖市',
  `city` bigint(20) DEFAULT NULL COMMENT '地级市/市辖区/市辖县',
  `county` bigint(20) DEFAULT NULL COMMENT '县级市/区/县',
  `town` bigint(20) DEFAULT NULL COMMENT '乡/镇/街道',
  `detail_addr` varchar(200) DEFAULT NULL COMMENT '详细地址',
  `longitude` varchar(20) DEFAULT NULL COMMENT '经度',
  `latitude` varchar(20) DEFAULT NULL COMMENT '纬度',
  `floor` varchar(20) DEFAULT NULL COMMENT '所在楼层',
  `manage_brand` varchar(20) DEFAULT NULL COMMENT '经营品牌',
  `plan_staff` int(11) DEFAULT NULL COMMENT '编制人数',
  `fact_staff` int(11) DEFAULT NULL COMMENT '实际人数',
  `store_manager_name` varchar(20) DEFAULT NULL COMMENT '店长姓名',
  `store_manager_tel` varchar(20) DEFAULT NULL COMMENT '店长联系电话',
  `supervisor_name` varchar(20) DEFAULT NULL COMMENT '主管',
  `traffic_monitoring` char(1) DEFAULT NULL COMMENT '客流监控(Y-有 N-无)',
  `video_monitoring` char(1) DEFAULT NULL COMMENT '视频监控(Y-有 N-无)',
  `valid_flag` char(1) DEFAULT 'Y' COMMENT '有效标识(Y-有效 N-作废)',
  `user_id` bigint(20) DEFAULT NULL,
  `es_valid_flag` char(1) DEFAULT 'Y' COMMENT '外部标识(Y-有效 N-作废)',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='店铺档案主表';

-- ----------------------------
-- Records of csc_store
-- ----------------------------
INSERT INTO `csc_store` VALUES ('97088503954800642', 'NY01', '測試店鋪', 'test001', '上海', '1', '1', null, '2017-04-22', '100', '1', '1', '1', null, '46546', null, null, '1', '1', '1', '1', '電池', '151211118965', '11', null, null, 'Y', '97088503954800640', 'Y', '2017-04-12 10:08:02');

-- ----------------------------
-- Table structure for csc_store_nature
-- ----------------------------
DROP TABLE IF EXISTS `csc_store_nature`;
CREATE TABLE `csc_store_nature` (
  `nature_id` bigint(20) unsigned NOT NULL COMMENT '经营性质主键',
  `esrow_id` varchar(20) DEFAULT NULL COMMENT '外部系统对应主键',
  `nature_name` varchar(32) NOT NULL COMMENT '经营性质名称',
  `valid_flag` char(1) DEFAULT 'Y' COMMENT '有效标识(Y-有效 N-作废)',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`nature_id`),
  KEY `idx_csc_store_nature_esrow_id` (`esrow_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='店铺经营性质资料表';

-- ----------------------------
-- Records of csc_store_nature
-- ----------------------------
INSERT INTO `csc_store_nature` VALUES ('97088503954800645', null, '直营', 'Y', '2017-04-12 11:04:24');
INSERT INTO `csc_store_nature` VALUES ('97088503954800646', null, '加盟', 'Y', '2017-04-12 11:05:09');

-- ----------------------------
-- Table structure for csc_store_status
-- ----------------------------
DROP TABLE IF EXISTS `csc_store_status`;
CREATE TABLE `csc_store_status` (
  `status_id` bigint(20) unsigned NOT NULL COMMENT '级别主键',
  `esrow_id` varchar(20) DEFAULT NULL COMMENT '外部系统对应主键',
  `sequence_id` tinyint(4) NOT NULL DEFAULT '1' COMMENT '显示顺序',
  `status_name` varchar(32) NOT NULL COMMENT '级别名称',
  `valid_flag` char(1) DEFAULT 'Y' COMMENT '有效标识(Y-有效 N-作废)',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`status_id`),
  KEY `idx_csc_store_status_esrow_id` (`esrow_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='店铺状态资料表';

-- ----------------------------
-- Records of csc_store_status
-- ----------------------------
INSERT INTO `csc_store_status` VALUES ('97088503954800647', null, '1', '正常', 'Y', '2017-04-12 11:10:23');
INSERT INTO `csc_store_status` VALUES ('97088503954800648', null, '1', '非正常', 'Y', '2017-04-12 11:10:40');
...
CREATE TABLE `sm_button` (
  `button_id` bigint(20) unsigned NOT NULL COMMENT '按钮主键',
  `button_no` varchar(20) NOT NULL COMMENT '按钮编号',
  `button_name` varchar(50) NOT NULL COMMENT '按钮名称',
  `button_type` char(1) DEFAULT NULL COMMENT '按钮类型(预留)',
  `menu_id` bigint(20) unsigned DEFAULT NULL COMMENT '所属菜单主键',
  `button_url` varchar(200) DEFAULT NULL COMMENT '按钮访问路径',
  `valid_flag` char(1) DEFAULT 'Y' COMMENT '有效标识(Y-有效 N-作废)',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`button_id`),
  UNIQUE KEY `idx_sm_button_button_no` (`button_no`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='系统按钮表';

-- ----------------------------
-- Records of sm_button
-- ----------------------------
INSERT INTO `sm_button` VALUES ('97045295577169927', 'Bu1489387172', '删除角色', null, '97045295577169926', '/smRole/deleteById', 'Y', '2017-03-17 17:54:36');
INSERT INTO `sm_button` VALUES ('97045295577169928', 'Bu1489387301', '修改-查看', null, '97045295577169926', '/smRole/selectById', 'Y', '2017-03-17 17:52:57');
INSERT INTO `sm_button` VALUES ('97055184974249984', 'Bu1489973520', '添加-查看', null, '97045295577169926', '/smRole/forAdd', 'Y', '2017-03-20 09:32:00');
INSERT INTO `sm_button` VALUES ('97055184974249985', 'Bu1489973685', '删除角色-多选', null, '97045295577169926', '/smRole/deleteByCheck', 'Y', '2017-03-20 09:34:45');
INSERT INTO `sm_button` VALUES ('97055184974249986', 'Bu1489973763', '添加-操作', null, '97045295577169926', '/smRole/save', 'Y', '2017-03-20 09:36:03');
INSERT INTO `sm_button` VALUES ('97055184974249987', 'Bu1489973801', '修改-操作', null, '97045295577169926', '/smRole/update', 'Y', '2017-03-20 09:36:41');
INSERT INTO `sm_button` VALUES ('97055184974249988', 'Bu1489974101', '添加菜单权限-操作', null, '97050827377606657', '/smMenu/save', 'Y', '2017-03-20 09:41:41');
INSERT INTO `sm_button` VALUES ('97055184974249989', 'Bu1489974159', '修改菜单权限-操作', null, '97050827377606657', '/smMenu/update', 'Y', '2017-03-20 09:42:39');
INSERT INTO `sm_button` VALUES ('97055184974249990', 'Bu1489974226', '删除菜单权限-操作', null, '97050827377606657', '/smMenu/deleteById', 'Y', '2017-03-20 09:43:46');
INSERT INTO `sm_button` VALUES ('97055184974249991', 'Bu1489974270', '添加按钮权限-操作', null, '97050827377606657', '/smButton/save', 'Y', '2017-03-20 09:44:30');
INSERT INTO `sm_button` VALUES ('97055184974249992', 'Bu1489974305', '修改按钮权限-操作', null, '97050827377606657', '/smButton/update', 'Y', '2017-03-20 09:45:05');
INSERT INTO `sm_button` VALUES ('97055184974249993', 'Bu1489974356', '删除按钮权限-操作', null, '97050827377606657', '/smButton/deleteById', 'Y', '2017-03-20 09:45:56');
INSERT INTO `sm_button` VALUES ('97055503472918528', 'Bu1489997779', '权限编辑-查看', null, '97045295577169926', '/smRoleFunc/selectByRole', 'Y', '2017-03-20 16:16:19');
INSERT INTO `sm_button` VALUES ('97055503472918530', 'Bu1489998693', '编辑角色权限-操作', null, '97045295577169926', '/smRoleFunc/add', 'Y', '2017-03-20 16:31:33');
INSERT INTO `sm_button` VALUES ('97059540507295744', 'Bu1490238012', '角色分配-查看', null, '97055503472918529', '/smUserRole/selectByInfo', 'Y', '2017-03-23 11:00:12');
INSERT INTO `sm_button` VALUES ('97059540507295787', 'Bu1490240733', '添加会员-查看', null, '97059540507295765', '/uscUser/forAdd', 'Y', '2017-03-23 11:45:33');
INSERT INTO `sm_button` VALUES ('97059540507295788', 'Bu1490240778', '删除会员-多选', null, '97059540507295765', '/uscUser/deleteByCheck', 'Y', '2017-03-23 11:46:18');
INSERT INTO `sm_button` VALUES ('97059540507295789', 'Bu1490240810', '删除会员', null, '97059540507295765', '/uscUser/deleteById', 'Y', '2017-03-23 11:46:50');
INSERT INTO `sm_button` VALUES ('97059540507295790', 'Bu1490240840', '修改会员-查看', null, '97059540507295765', '/uscUser/selectById', 'Y', '2017-03-23 11:47:20');
INSERT INTO `sm_button` VALUES ('97059540507295791', 'Bu1490240891', '添加会员-操作', null, '97059540507295765', '/uscUser/save', 'Y', '2017-03-23 11:48:11');
INSERT INTO `sm_button` VALUES ('97059540507295792', 'Bu1490240917', '修改会员-操作', null, '97059540507295765', '/uscUser/update', 'Y', '2017-03-24 17:39:31');
INSERT INTO `sm_button` VALUES ('97060999001014323', 'Bu1490349086', '权限分配-操作', null, '97055503472918529', '/smUserRole/add', 'Y', '2017-03-25 14:01:15');
INSERT INTO `sm_button` VALUES ('97062500494737444', 'Bu1490422776', '添加门店-查看', null, '97062500494737409', '/cscStore/add', 'Y', '2017-03-25 14:19:36');
INSERT INTO `sm_button` VALUES ('97062500494737445', 'Bu1490422842', '修改门店-查看', null, '97062500494737409', '/cscStore/selectById', 'Y', '2017-03-25 14:20:42');
INSERT INTO `sm_button` VALUES ('97062500494737446', 'Bu1490422872', '删除门店', null, '97062500494737409', '/cscStore/deleteById', 'Y', '2017-03-25 14:21:12');
INSERT INTO `sm_button` VALUES ('97062500494737447', 'Bu1490422897', '删除门店-多选', null, '97062500494737409', '/cscStore/deleteByCheck', 'Y', '2017-03-25 14:21:37');
INSERT INTO `sm_button` VALUES ('97062500494737448', 'Bu1490422934', '添加门店-操作', null, '97062500494737409', '/cscStore/save', 'Y', '2017-03-25 14:22:14');
INSERT INTO `sm_button` VALUES ('97062500494737449', 'Bu1490422958', '修改门店-操作', null, '97062500494737409', '/cscStore/update', 'Y', '2017-03-25 14:22:38');
INSERT INTO `sm_button` VALUES ('97066776352784386', 'Bu1490670414', '经销商添加-查看', null, '97066776352784385', '/cscCustomer/add', 'Y', '2017-03-28 11:06:54');
INSERT INTO `sm_button` VALUES ('97066776352784387', 'Bu1490671034', '经销商修改-查看', null, '97066776352784385', '/cscCustomer/selectById', 'Y', '2017-03-28 11:17:14');
INSERT INTO `sm_button` VALUES ('97066776352784388', 'Bu1490671094', '经销商添加-操作', null, '97066776352784385', '/cscCustomer/save', 'Y', '2017-03-28 11:18:14');
INSERT INTO `sm_button` VALUES ('97066776352784389', 'Bu1490671128', '经销商修改-操作', null, '97066776352784385', '/cscCustomer/update', 'Y', '2017-03-28 11:18:48');
INSERT INTO `sm_button` VALUES ('97066776352784390', 'Bu1490671162', '经销商删除-操作', null, '97066776352784385', '/cscCustomer/deleteById', 'Y', '2017-03-28 11:19:22');
INSERT INTO `sm_button` VALUES ('97066776352784391', 'Bu1490671199', '经销商删除-多选', null, '97066776352784385', '/cscCustomer/deleteByCheck', 'Y', '2017-03-28 11:19:59');
INSERT INTO `sm_button` VALUES ('97071119319695504', 'Bu1490932658', '经销商查找带回', null, '97062500494737409', '/cscStore/lookup', 'Y', '2017-04-10 16:58:52');
...
CREATE TABLE `sm_menu` (
  ...
  `menu_no` varchar(40) NOT NULL COMMENT '菜单编号',
  `menu_name` varchar(50) NOT NULL COMMENT '菜单名称',
  `display_order` varchar(50) DEFAULT NULL COMMENT '菜单显示顺序',
  `menu_level` char(1) NOT NULL COMMENT '菜单级别',
  `menu_type` tinyint(4) DEFAULT '1' COMMENT '菜单类别*',
  `parent_menu_id` bigint(20) unsigned DEFAULT NULL COMMENT '父级菜单主键',
  `is_leaf` char(1) NOT NULL COMMENT '是否末级菜单(Y-是 N-否)',
  `is_button_power` char(1) DEFAULT 'N' COMMENT '控制按钮权限(Y-是 N-否)',
  `is_report` char(1) DEFAULT 'N' COMMENT '是否报表菜单(Y-是 N-否)',
  `page_url` varchar(100) DEFAULT NULL COMMENT '页面访问路径',
  `designer` varchar(100) DEFAULT NULL COMMENT '设计人员',
  `developer` varchar(100) DEFAULT NULL COMMENT '开发人员',
  `contributer` varchar(200) DEFAULT NULL COMMENT '贡献人员',
  `remark` varchar(100) DEFAULT NULL COMMENT '备注说明',
  `valid_flag` char(1) DEFAULT 'Y' COMMENT '有效标识(Y-有效 N-作废)',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`menu_id`),
  UNIQUE KEY `idx_sm_menu_menu_no` (`menu_no`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='系统菜单表';

-- ----------------------------
-- Records of sm_menu
-- ----------------------------
INSERT INTO `sm_menu` VALUES ('97045295577169924', 'Me1489385041', '设置管理', '**', '1', null, '0', 'N', null, null, '/**', null, null, null, '权限设置管理', 'Y', '2017-03-20 15:57:57');
INSERT INTO `sm_menu` VALUES ('97045295577169926', 'Me1489386226', '角色权限管理', 'smRole', '2', null, '97045295577169924', 'Y', null, null, '/smRole/selectByList', null, null, null, '角色权限列表菜单', 'Y', '2017-03-20 15:58:04');
INSERT INTO `sm_menu` VALUES ('97050827377606657', 'Me1489744810', '菜单权限管理', 'smRoleFunc', '2', null, '97045295577169924', 'Y', null, null, '/smRoleFunc/selectByInfo', null, null, null, '菜单权限管理列表', 'Y', '2017-03-20 15:58:01');
INSERT INTO `sm_menu` VALUES ('97055184974250009', 'Me1489978875', '人员管理', '**', '1', null, '0', 'N', null, null, '/**', null, null, null, '人员管理模块', 'Y', '2017-03-20 15:58:18');
INSERT INTO `sm_menu` VALUES ('97055503472918529', 'Me1489998538', '管理员管理', 'uscUser', '2', null, '97055184974250009', 'Y', null, null, '/uscUser/selectByList', null, null, null, '最牛逼的管理员', 'Y', '2017-03-20 16:28:58');
INSERT INTO `sm_menu` VALUES ('97059540507295765', 'Me1490238782', '会员管理', 'uscUser', '2', null, '97055184974250009', 'Y', null, null, '/uscUser/selectByUserList', null, null, null, '会员管理', 'Y', '2017-03-23 11:13:02');
INSERT INTO `sm_menu` VALUES ('97062500494737408', 'Me1490421011', '渠道管理', '**', '1', null, '0', 'N', null, null, '/**', null, null, null, '门店等管理', 'Y', '2017-03-25 13:50:44');
INSERT INTO `sm_menu` VALUES ('97062500494737409', 'Me1490421087', '门店管理', 'cscStore', '2', null, '97062500494737408', 'Y', null, null, '/cscStore/selectByList', null, null, null, '门店基本管理', 'Y', '2017-03-25 13:55:09');
INSERT INTO `sm_menu` VALUES ('97066776352784385', 'Me1490670056', '经销商管理', 'cscCustomer', '2', null, '97062500494737408', 'Y', null, null, '/cscCustomer/selectByList', null, null, null, '经销商管理列表', 'Y', '2017-03-28 11:00:56');
INSERT INTO `sm_menu` VALUES ('97071119319695360', 'Me1490925288', '经销商管理', 'uscUser', '2', null, '97055184974250009', 'Y', null, null, '/uscUser/selectByCusList', null, null, null, '经销商管理列表', 'Y', '2017-03-31 09:54:48');
INSERT INTO `sm_menu` VALUES ('97071119319695361', 'Me1490925340', '店员管理', 'uscUser', '2', null, '97055184974250009', 'Y', null, null, '/uscUser/selectByStoreList', null, null, null, '门店店员管理列表', 'Y', '2017-03-31 09:55:40');
...
CREATE TABLE `sm_role` (
  ...
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`role_id`),
  UNIQUE KEY `idx_sm_role_role_no` (`role_no`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='系统角色表';

-- ----------------------------
-- Records of sm_role
-- ----------------------------
INSERT INTO `sm_role` VALUES ('97036346459160577', 'Ro1488855688', '草鸡管理员', '最牛逼的管理员', 'Y', '2017-03-07 11:01:28');
INSERT INTO `sm_role` VALUES ('97085651224100864', 'Ro1491796986', '经销商', '经销商角色', 'Y', '2017-04-10 12:03:06');
...
CREATE TABLE `sm_role_func` (
  `row_id` bigint(20) unsigned NOT NULL COMMENT '记录行主键',
  `role_id` bigint(20) unsigned NOT NULL COMMENT '角色主键',
  `func_type` tinyint(4) NOT NULL COMMENT '功能类型(1-菜单 2-按钮)',
  `func_id` bigint(20) unsigned NOT NULL COMMENT '功能主键',
  `valid_flag` char(1) DEFAULT 'Y' COMMENT '有效标识(Y-有效 N-作废)',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`row_id`),
  KEY `idx_sm_role_func_role_id` (`role_id`) USING BTREE,
  KEY `idx_sm_role_func_func_id` (`func_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='角色功能权限表';

-- ----------------------------
-- Records of sm_role_func
-- ----------------------------
INSERT INTO `sm_role_func` VALUES ('97071119319695505', '97036346459160577', '1', '97062500494737408', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695506', '97036346459160577', '1', '97066776352784385', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695507', '97036346459160577', '1', '97062500494737409', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695508', '97036346459160577', '1', '97055184974250009', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695509', '97036346459160577', '1', '97071119319695361', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695510', '97036346459160577', '1', '97071119319695360', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695511', '97036346459160577', '1', '97059540507295765', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695512', '97036346459160577', '1', '97055503472918529', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695513', '97036346459160577', '1', '97045295577169924', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695514', '97036346459160577', '1', '97045295577169926', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695515', '97036346459160577', '1', '97050827377606657', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695516', '97036346459160577', '2', '97066776352784391', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695517', '97036346459160577', '2', '97066776352784390', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695518', '97036346459160577', '2', '97066776352784389', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695519', '97036346459160577', '2', '97066776352784388', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695520', '97036346459160577', '2', '97066776352784387', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695521', '97036346459160577', '2', '97066776352784386', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695522', '97036346459160577', '2', '97071119319695504', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695523', '97036346459160577', '2', '97062500494737449', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695524', '97036346459160577', '2', '97062500494737448', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695525', '97036346459160577', '2', '97062500494737447', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695526', '97036346459160577', '2', '97062500494737446', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695527', '97036346459160577', '2', '97062500494737445', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695528', '97036346459160577', '2', '97062500494737444', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695529', '97036346459160577', '2', '97059540507295792', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695530', '97036346459160577', '2', '97059540507295791', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695531', '97036346459160577', '2', '97059540507295790', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695532', '97036346459160577', '2', '97059540507295789', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695533', '97036346459160577', '2', '97059540507295788', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695534', '97036346459160577', '2', '97059540507295787', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695535', '97036346459160577', '2', '97060999001014323', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695536', '97036346459160577', '2', '97059540507295744', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695537', '97036346459160577', '2', '97055503472918530', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695538', '97036346459160577', '2', '97055503472918528', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695539', '97036346459160577', '2', '97055184974249987', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695540', '97036346459160577', '2', '97055184974249986', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695541', '97036346459160577', '2', '97055184974249985', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695542', '97036346459160577', '2', '97055184974249984', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695543', '97036346459160577', '2', '97045295577169927', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695544', '97036346459160577', '2', '97045295577169928', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695545', '97036346459160577', '2', '97055184974249993', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695546', '97036346459160577', '2', '97055184974249992', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695547', '97036346459160577', '2', '97055184974249991', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695548', '97036346459160577', '2', '97055184974249990', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695549', '97036346459160577', '2', '97055184974249989', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97071119319695550', '97036346459160577', '2', '97055184974249988', 'Y', '2017-03-31 11:58:16');
INSERT INTO `sm_role_func` VALUES ('97085651224100865', '97085651224100864', '1', '97062500494737408', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100866', '97085651224100864', '1', '97062500494737409', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100867', '97085651224100864', '1', '97055184974250009', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100868', '97085651224100864', '1', '97071119319695361', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100869', '97085651224100864', '1', '97059540507295765', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100870', '97085651224100864', '2', '97071119319695504', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100871', '97085651224100864', '2', '97062500494737449', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100872', '97085651224100864', '2', '97062500494737448', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100873', '97085651224100864', '2', '97062500494737447', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100874', '97085651224100864', '2', '97062500494737446', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100875', '97085651224100864', '2', '97062500494737445', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100876', '97085651224100864', '2', '97062500494737444', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100877', '97085651224100864', '2', '97059540507295792', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100878', '97085651224100864', '2', '97059540507295791', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100879', '97085651224100864', '2', '97059540507295790', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100880', '97085651224100864', '2', '97059540507295789', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100881', '97085651224100864', '2', '97059540507295788', 'Y', '2017-04-10 15:01:00');
INSERT INTO `sm_role_func` VALUES ('97085651224100882', '97085651224100864', '2', '97059540507295787', 'Y', '2017-04-10 15:01:00');
...
CREATE TABLE `sm_user_org` (
  ...
  `org_type` varchar(2) NOT NULL COMMENT '组织类型*',
  `org_no` varchar(20) NOT NULL COMMENT '组织编号',
  `valid_flag` char(1) DEFAULT 'Y' COMMENT '有效标识(Y-有效 N-作废)',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`row_id`),
  KEY `idx_sm_user_org_user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户组织权限表';
...
CREATE TABLE `sm_user_role` (
  ...
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`row_id`),
  KEY `idx_sm_user_role_user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户角色权限表';

-- ----------------------------
-- Records of sm_user_role
-- ----------------------------
INSERT INTO `sm_user_role` VALUES ('97046483538280453', '97079832046731310', '97036346459160577', 'Y', '2017-04-10 14:44:47');
INSERT INTO `sm_user_role` VALUES ('97087064788434948', '97087064788434944', '97085651224100864', 'Y', '2017-04-11 11:59:39');

-- ----------------------------
-- Table structure for sm_user_store
-- ----------------------------
DROP TABLE IF EXISTS `sm_user_store`;
CREATE TABLE `sm_user_store` (
  `row_id` bigint(20) unsigned NOT NULL COMMENT '记录行主键',
  `user_id` bigint(20) unsigned NOT NULL COMMENT '用户主键',
  `store_no` varchar(20) NOT NULL COMMENT '店铺编号',
  `valid_flag` char(1) DEFAULT 'Y' COMMENT '有效标识(Y-有效 N-作废)',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`row_id`),
  KEY `idx_sm_user_store_user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户管理店铺表';

-- ----------------------------
-- Records of sm_user_store
-- ----------------------------
INSERT INTO `sm_user_store` VALUES ('97079832046731323', '97079832046731310', 'admin', 'Y', '2017-04-10 14:57:53');
INSERT INTO `sm_user_store` VALUES ('97087064788434947', '97087064788434944', 'test001', 'Y', '2017-04-11 11:58:44');
INSERT INTO `sm_user_store` VALUES ('97088503954800643', '97088503954800640', 'NY01', 'Y', '2017-04-12 10:08:02');

-- ----------------------------
-- Table structure for usc_clerk
-- ----------------------------
DROP TABLE IF EXISTS `usc_clerk`;
CREATE TABLE `usc_clerk` (
  `row_id` bigint(20) unsigned NOT NULL COMMENT '记录行主键',
  `clerk_id` bigint(20) unsigned NOT NULL COMMENT '营业员主键*',
  `belong_store` varchar(20) NOT NULL COMMENT '归属店铺',
  `entry_date` date DEFAULT NULL COMMENT '入职日期',
  `is_manager` char(1) DEFAULT 'N' COMMENT '是否店长(Y-是 N-否)',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`row_id`),
  KEY `idx_usc_clerk_clerk_id` (`clerk_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='店铺营业员管理表';

-- ----------------------------
-- Records of usc_clerk
-- ----------------------------
INSERT INTO `usc_clerk` VALUES ('97088503954800644', '97088503954800640', 'NY01', null, null, '2017-04-12 10:08:02');

-- ----------------------------
-- Table structure for usc_member
-- ----------------------------
DROP TABLE IF EXISTS `usc_member`;
CREATE TABLE `usc_member` (
  `member_id` bigint(20) unsigned NOT NULL COMMENT '会员主键*',
  `create_store` varchar(20) NOT NULL DEFAULT 'Y1001' COMMENT '创建店铺*',
  `belong_store` varchar(20) NOT NULL DEFAULT 'Y1001' COMMENT '归属店铺*',
  `card_no` varchar(60) DEFAULT NULL COMMENT '会员卡号',
  `member_level` bigint(20) unsigned NOT NULL DEFAULT '1' COMMENT '会员等级*',
  `member_image` varchar(100) DEFAULT NULL COMMENT '会员头像',
  `first_classify` varchar(10) DEFAULT NULL COMMENT '来源渠道一级分类',
  `second_classify` varchar(10) DEFAULT NULL COMMENT '来源渠道二级分类',
  `third_classify` varchar(10) DEFAULT NULL COMMENT '来源渠道三级分类',
  `last_buy_date` date DEFAULT NULL COMMENT '最近一次消费日期',
  `create_date` date DEFAULT NULL COMMENT '创建日期*',
  `member_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '会员状态*',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`member_id`),
  KEY `idx_usc_member_member_level` (`member_level`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='会员基本资料表';

-- ----------------------------
-- Records of usc_member
-- ----------------------------
INSERT INTO `usc_member` VALUES ('97079832046731310', 'admin', 'admin', null, '5', null, null, null, null, '2017-03-24', null, '0', '2017-04-10 15:04:25');
INSERT INTO `usc_member` VALUES ('97087064788434944', 'test001', 'test001', 'Us1491883124', '1', null, null, null, null, null, '2017-04-11', '0', '2017-04-11 11:58:44');
INSERT INTO `usc_member` VALUES ('97088503954800640', 'NY01', 'test001', 'Us1491962882', '1', null, null, null, null, null, '2017-04-12', '0', '2017-04-12 10:08:02');

-- ----------------------------
-- Table structure for usc_member_wcpn
-- ----------------------------
DROP TABLE IF EXISTS `usc_member_wcpn`;
CREATE TABLE `usc_member_wcpn` (
  `row_id` bigint(20) unsigned NOT NULL COMMENT '记录行主键',
  `member_id` bigint(20) unsigned NOT NULL COMMENT '会员主键',
  `public_no` varchar(20) DEFAULT NULL COMMENT '微信公众号编码',
  `open_id` varchar(64) DEFAULT NULL COMMENT '对应微信公众号ID',
  `is_sub` char(2) DEFAULT 'N' COMMENT '是否关注',
  `remark` varchar(100) DEFAULT NULL COMMENT '备注说明',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`row_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='会员关注公众号记录表';

-- ----------------------------
-- Records of usc_member_wcpn
-- ----------------------------
INSERT INTO `usc_member_wcpn` VALUES ('97079832046731311', '97079832046731310', null, null, 'N', null, '2017-04-10 15:03:54');
INSERT INTO `usc_member_wcpn` VALUES ('97087064788434945', '97087064788434944', null, null, null, null, '2017-04-11 11:58:44');
INSERT INTO `usc_member_wcpn` VALUES ('97088503954800641', '97088503954800640', null, null, null, null, '2017-04-12 10:08:02');
...
CREATE TABLE `usc_user` (
  ...
  `gender` varchar(6) DEFAULT NULL COMMENT '用户性别',
  `id_card_no` varchar(30) DEFAULT NULL COMMENT '身份证号码',
  `data_authority` tinyint(3) unsigned NOT NULL DEFAULT '50' COMMENT '数据权限*',
  `dept_id` bigint(20) DEFAULT NULL COMMENT '用户所属部门主键',
  `mobile_no` varchar(30) DEFAULT NULL COMMENT '手机号码',
  `email_no` varchar(80) DEFAULT NULL COMMENT '电子邮箱',
  ...
  `valid_flag` char(1) DEFAULT 'Y' COMMENT '有效标识(Y-有效 N-作废)',
  `lock_flag` char(1) DEFAULT 'N' COMMENT '锁定标识(Y-锁定 N-未锁定)',
  `create_date` date DEFAULT NULL COMMENT '创建日期',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  PRIMARY KEY (`user_id`),
  UNIQUE KEY `idx_usc_user_user_no` (`user_no`) USING BTREE,
  UNIQUE KEY `idx_usc_user_id_card_no` (`id_card_no`) USING BTREE,
  KEY `idx_usc_user_dept_id` (`dept_id`) USING BTREE,
  KEY `idx_usc_user_mobile_no` (`mobile_no`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户基本资料表';

-- ----------------------------
-- Records of usc_user
-- ----------------------------
INSERT INTO `usc_user` VALUES ('97079832046731310', 'admin', '超级管理员', '超级管理员', 'ac0e7d037817094e9e0b4441f9bae3209d67b02fa484917065f71b16109a1a78', 'MALE', '1', '50', null, '', '1', '2017-03-24', null, null, null, null, '', '1', '575', 'Y', 'N', '2017-03-24', '2017-04-10 14:52:39');
INSERT INTO `usc_user` VALUES ('97087064788434944', 'Us1491883124', null, '儅', '510c1346144e8f988267733481645e896cf0f760eadfbed71d26452359a99ba7', null, null, '50', null, '15121118965', null, null, null, null, null, null, null, '3', null, 'Y', 'N', '2017-04-11', '2017-04-11 11:58:44');
INSERT INTO `usc_user` VALUES ('97088503954800640', 'Us1491962882', null, '電池', 'd214cb623feb2e27a99a730bab86f6872a53146ffc4684c1417b700600f3d07d', null, null, '50', null, '151211118965', null, null, null, null, null, null, null, '4', null, 'Y', 'N', '2017-04-12', '2017-04-12 10:08:02');
